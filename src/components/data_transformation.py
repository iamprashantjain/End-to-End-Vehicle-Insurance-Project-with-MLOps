...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            preprocessor = ColumnTransformer(
                ...
                remainder='passthrough'  # skip all other cols
            )
    ...
    def _drop_columns(self, df):
        ...
        logging.info("Dropping columns from df defined in schema.yaml file")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # Apply custom transformations in specified sequence on both train & test df
            ...
            #concatinating input & target features and creating training & test array
